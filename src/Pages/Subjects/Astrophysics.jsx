  ...
  return (
    <div>
      ...
      <div style={sectionStyle}>
        ...
        <p>
          Physical science explores the non-living world, seeking to reveal the
          fundamental laws of nature. Main
        </p>
        <p>
          areas include physics, astronomy, chemistry, and earth sciences, such
          as meteorology and geology.
        </p>
      </div>
