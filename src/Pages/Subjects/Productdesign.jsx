  ...
  return (
    <div>
      ...
      <div style={sectionStyle}>
        ...
        <p>
          Product design teaches you to create user-friendly, convenient
          products.{" "}
        </p>
      </div>
      ...
      <div style={statisticsSection}>
        <div style={statItemStyle}>
          ...
          <p>
            <strong>$50,757</strong> is the annual median salary for an
            entry-level product designer in the U.S.
          </p>
        </div>
        <div style={statItemStyle}>
          <div style={iconStyle}>📈</div>
          <p>
            <strong>86%</strong> growth in job opportunities within the product
            design field, according to LinkedIn.
          </p>
        </div>
        <div style={statItemStyle}>
          <div style={iconStyle}>💼</div>
          <p>
            <strong>30%</strong> more revenue is generated by businesses that
            prioritize product design.
          </p>
        </div>
        <div style={statItemStyle}>
          <div style={iconStyle}>🔧</div>
          <p>
            Companies focusing on product design see, on average,{" "}
            <strong>30%</strong> higher revenue.
          </p>
        </div>
      </div>
