...
const Beauty = () => {
  ...
  const sectionStyle = {
    backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/beauty.jpeg)`,
  ...
  const faqItems = [
    ...
    },
    {
      ...
      content2:
        "You can opt for a diploma or certificate which ranges from 6 months to a year. Generally, you will have to have completed high school before you enrol in any type of beauty school or for a bachelor's degree. Beauty school combines both academic and practicums to prepare a student for a career in Beauty Care. The training is extensive and through. You are mentored by seasoned professionals in the field of Beauty Care. Both book learning and hands-on training will be part of your education. If you enrol in cosmetology school full-time, you will spend six to eight hours every day in class or training.",
      content3:
        "In contrast to a diploma, a bachelor’s in Beauty Care is more rigorous. After completing this degree graduates can execute a variety of activities and have a through understanding of various themes in the beauty business. Only a very few institutes offer degree programmes in Beauty Care.",
