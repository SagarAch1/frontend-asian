...
const services = [
  {
    ...
    description:
      "Explore different course subjects that align to your study objectives.",
    link: "/browsesubject",
  },
  {
    icon: "🎓",
  ...
  },
  {
    ...
    description:
      "FastLane allows you to see if you can get into a course before you apply.",
    link: "#",
  },
  {
    icon: "💼",
  ...
  {
    icon: "📱",
    title: "AIEC-Global Live app",
    description:
      "Download the AIEC-Global Live app to browse and shortlist courses, track your applications, and much more.",
    link: "#",
  },
  {
    icon: "📅",
    title: "Events",
    description:
      "Explore events where you can meet with partner universities and discuss your dream to study abroad.",
