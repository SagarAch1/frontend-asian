...
const guides = [
  { title: 'Processing Cycle', buttonText: 'Download' },
  { title: 'SOP Guide', buttonText: 'Download' },
  { title: 'Document checklist for Australia', buttonText: 'Download' },
  { title: 'Three Years Bachelor + PQP+ Pre Master', buttonText: 'Download' },
];
        ...
        <div style={styles.guideContainer}>
          {guides.map((guide, index) => (
            <div key={index} style={styles.card}>
              ...
              <button style={styles.button}>{guide.buttonText}</button>
            </div>
          ))}
        </div>
