...
const scholarshipData = [
  ...
  {
    id: 12,
    title: "International Foundation Research Excellence Scholarship",
    institute: "Contact AIEC",
    location: "United Kingdom",
    type: "Foundation",
  },
  ...
  return (
    <div style={{ padding: "20px", maxWidth: "1200px", margin: "0 auto" }}>
      ...
      <h2 style={{ textAlign: "center", margin: "60px 0" }}>
        Found {scholarships.length} Foundation Scholarships
      </h2>
...
export default FoundationScholar;
