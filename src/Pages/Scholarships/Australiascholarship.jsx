...
const programs = [
  {
    university: " Destination Australia International Scholarships",
    location: " Australia",
  ...
  {
    university: " Australia Awards Scholarship",
    location: " Australia",
  ...
  {
    university: " Vice Chancellor’s International Diversification Scholarship ",
    location: " Australia",
  ...
  {
    university: " Research Training Program Stipend Scholarship",
    location: " Australia",
  ...
  {
    university: " Sustainable Development Goals International Scholarship",
    location: " Australia ",
        ...
        {filteredPrograms ? (
          <>
            <DataCount size="1.5em" bold>
              Found {filteredPrograms.length} Scholarships in Australia.
            </DataCount>
            <GridContainer>
...
export default Australiascholarships;
