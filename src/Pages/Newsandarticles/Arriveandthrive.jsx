      ...
      <div style={styles.page}>
        <div style={styles.contentSection}>
          <div style={styles.leftColumn}>
            ...
            <p>
              ...
              provide continuous support, whether it’s helping with
              accommodation, managing finances, or offering guidance through the
              immigration process. Your well-being is our priority, and we’ve
              partnered with mental health experts to ensure you have access to
              all the help you need. This is your moment to thrive and build a
        ...
        <div style={styles.additionalSection}>
          ...
          <div style={styles.listItem}>
            ...
            <p>
              Make the most of your time abroad and embrace your new
              surroundings.
            </p>
          </div>
          <div style={styles.listItem}>
        ...
        <div style={styles.additionalSection}>
          ...
          <div style={styles.listItem}>
            ...
            <p>
              ...
              groups to meet people with similar passions. There will be
              numerous events to participate in, providing opportunities to
              create lasting friendships, discover job prospects, and get
              answers to your questions. Stay open to new experiences, and
              you’ll build meaningful relationships that enhance your time
              abroad.
            </p>
          </div>
          <div style={styles.listItem}>
          ...
          <div style={styles.listItem}>
            ...
            <p>
              ...
              part-time. To find opportunities, check your university’s job
              board, look at local job listings online, network with other
              students, and ask around at local businesses. Be sure to ask about
              any work-study programs that may be available as well.
            </p>
          </div>
          <div style={styles.listItem}>
            <h3 style={styles.listItemTitle}>
            ...
            <p>
              ...
              counsellors in your city. For migration-related questions,
              AIEC-Global can provide assistance in specific locations.
              Additionally, we’ve partnered with mental health professionals who
              can offer support throughout your journey.
            </p>
          </div>
        </div>
        <FormPage />
